...
| V2 on Cloudflare (Phase C live: 4 exchanges + arb scanner) | `docs/v2-cf-containers-architecture.md`, `docs/v2-oms-cloudflare-native.md`, `deploy/cf-containers/oms-v2/` (prod), `deploy/cf-containers/proof-of-concept/` (research) |
