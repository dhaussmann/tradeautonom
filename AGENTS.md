...
| V2 on Cloudflare (Phase E live: quote + meta + arb scanner + 4 exchanges) | `docs/v2-cf-containers-architecture.md`, `docs/v2-oms-cloudflare-native.md`, `deploy/cf-containers/oms-v2/` (prod), `deploy/cf-containers/proof-of-concept/` (research) |
